(function() {
  ...
  var notice = element(
    by.cssContainingText(
      ".Notice",
      "(from capita's system) that match your search criteria"
    )
  );
  ...
  describe("historc cases", function() {
    ...
    describe("with historic results", function() {
      xit("should show historc suggestions notice if search matches", function() {
        var query = element(by.name("q"));
      ...
      xit("should allow you to view historic cases", function() {
        element(by.cssContainingText("a", "View historic cases")).click();
        expect(browser.getCurrentUrl()).toContain("historic");
      });

      xit("should keep the search term in the new state url", function() {
        expect(browser.getCurrentUrl()).toContain("search=bob");
      });

      xit("should be able to visit the detail page", function() {
