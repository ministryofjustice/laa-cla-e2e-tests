    ...
    describe("A provider", function() {
      ...
      it("should fill the search field, return results and clear the search", function() {
        ...
        expect(browser.getCurrentUrl()).toBe(
          utils.getBaseAbsoluteUrl(CONSTANTS.providerBaseUrl)
        );
      });
      ...
      xit("should filter and show all test cases", function() {
      ...
      xit("should filter and show only new cases", function() {
        clickFilter("New");
        assertCasesLength(1);
        assertContainsCase("TP-9999-0001");
      ...
      xit("should filter and show only opened cases", function() {
        clickFilter("Opened");
        assertCasesLength(1);
        assertContainsCase("TP-9999-0003");
      });
