...
module.exports = {
  ...
  "Childcare fields": function(client) {
    client
      ...
      .back()
      .waitForElementPresent("#have_partner-0", 5000, "  - Back to /about")
      ...
      .setValue(
        'input[name="your_income-child_tax_credit-per_interval_value"]',
        0
      )
      .setValue('input[name="your_income-maintenance-per_interval_value"]', 0)
      .setValue('input[name="your_income-pension-per_interval_value"]', 0)
      ...
      .conditionalFormSubmit(true)
      .assert.visible(
        'input[name="childcare-per_interval_value"]',
  ...
  "Context-dependent text for partner": function(client) {
    client.assert
      .containsText(
        "body",
        "Money you pay your landlord",
        "  - Has help text for Rent"
      )
      .assert.containsText(
        "body",
        "Money you pay to an ex-partner for their living costs",
        "  - Has help text for Maintenance"
      )
      .assert.containsText(
        "body",
        "Money you pay per month towards your criminal legal aid",
      ...
      .assert.containsText(
        "body",
        "Money you and your partner pay your landlord",
        "  - Has help text for Rent"
      )
      .assert.containsText(
        "body",
        "Money you and/or your partner pay to an ex-partner for their living costs",
        "  - Has help text for Maintenance"
      )
      .assert.containsText(
        "body",
        "Money you and/or your partner pay per month towards your criminal legal aid",
        "  - Has help text for Monthly Income Contribution Order"
      )
      .assert.containsText(
        "body",
        "Money you and your partner pay for your child to be looked after while you work or study",
        "  - Has help text for Childcare"
      );
  },
