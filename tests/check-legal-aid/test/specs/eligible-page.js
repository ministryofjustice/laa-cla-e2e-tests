...
module.exports = {
  ...
  "Review page": function(client) {
    client
      .waitForElementVisible(".answers-summary", 2000, "  - Page is ready")
      .conditionalFormSubmit(true);
  },
  ...
  "Postcode address finder": function(client) {
    client
      ...
      .assert.elementPresent(
        'div.address-list option[value="0"]',
        "  - `.address-list` dropdown has options"
      )
      .assert.containsText(
        'div.address-list option[value="0"]',
        "3 Crescent Road, London, E18 1JA",
      ...
      .useXpath()
      .waitForElementVisible(
        '//input[@id="address-post_code"]/ancestor::fieldset//div[@class="form-row field-error"]',
        25000,
        "  - Field marked as invalid"
      )
      .assert.containsText(
        '//input[@id="address-post_code"]/ancestor::fieldset//div[@class="form-row field-error"]',
        "No addresses were found with that postcode, but you can still enter your address manually",
